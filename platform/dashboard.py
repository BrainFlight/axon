try:
    ...
    raise ImportError("Required modules are not installed. Ensure Streamlit and Requests are installed.") from e
    ...
    if prompt.strip():
        with st.spinner("Querying the model..."):
            try:
                ...
                st.text_area("Output: ", value=str(result.get("output", result)["response"]["Response"]), height=400, disabled=True)
