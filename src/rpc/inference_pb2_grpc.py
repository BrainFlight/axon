...
import rpc.inference_pb2 as inference__pb2
...
class InferenceServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ConfigureModel = channel.unary_unary(
            "/inference.InferenceService/ConfigureModel",
            request_serializer=inference__pb2.ConfigRequest.SerializeToString,
            response_deserializer=inference__pb2.ConfigResponse.FromString,
...
def add_InferenceServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "ConfigureModel": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=inference__pb2.ConfigRequest.FromString,
            response_serializer=inference__pb2.ConfigResponse.SerializeToString,
        ),
...
class InferenceService(object):
    ...
    def ConfigureModel(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/inference.InferenceService/ConfigureModel",
            inference__pb2.ConfigRequest.SerializeToString,
            inference__pb2.ConfigResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
